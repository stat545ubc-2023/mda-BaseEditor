...
building_permits%>%
  ...
  select(permit_number, property_use, project_value, type_of_work, specific_use_category, year)
...
All of these questions hope to feed into the overall goal of examining how money is allocated within housing, and how this is changing across the whole scale of development in Vancouver.
